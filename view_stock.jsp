          ...
          <table id="myTable">
            ...
            <tbody>
                ...
                try {
                  ...
                  String queryString = "SELECT i.item_id as item_id, i.name as name, i.cost as cost, i.stock as stock, i.manufacturer as manufacturer, g.name as garage FROM Item i JOIN Garage g ON i.garage_id = g.garage_id";
                 ...
                 while(resultSet.next()) { %>
                    <tr>
                        ...
                        <td style="text-align: center;"><%= resultSet.getString("stock") %></td>
                        <td style="text-align: center;"><%= resultSet.getString("manufacturer") %></td>
                        <td style="text-align: center;"><%= resultSet.getString("garage") %></td>
                        <td style="text-align: center;">
                            <a href='./edit_stock.jsp?ID=<%= resultSet.getInt("item_id")%>' class="filter-by">Edit</a>
                        </td>
                        <td style="text-align: center;">
                            <a href='./delete_stock.jsp?ID=<%= resultSet.getInt("item_id")%>' class="filter-by">Remove</a>
                        </td>
                    </tr>
                <%  
                }
