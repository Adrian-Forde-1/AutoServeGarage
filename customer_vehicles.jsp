          ...
          <table id="myTable">
            <thead>
              <tr class="header">
                ...
                <th style="text-align: center;">Times Serviced</th>
              </tr>
            </thead>
            <tbody>
                <%
                ...
                try {
                  ...
                  int customerID = Integer.parseInt((String)session.getAttribute("userID"));
                  
                  String queryString = "SELECT * FROM Vehicle WHERE user_id = '" + customerID + "'";
                 ...
                 while(resultSet.next()) {%>
                  <tr>
                    ...
                    <td style="text-align: center;"><%= resultSet.getString("milage") %></td>
                    <td style="text-align: center; text-transform: capitalize;"><%= resultSet.getString("color") %></td>
                    <td style="text-align: center;"><%= resultSet.getString("times_serviced") %></td>
                </tr>
                <%  
                }
