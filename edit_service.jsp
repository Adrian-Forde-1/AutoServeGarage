    ...
    <div class="dashboard__wrapper">
      ...
      <%
          ...
          try {
            ...
            String queryString = "SELECT * FROM Services_Offered WHERE offered_service_id = '" + serviceID + "'";
                ...
                <div class="dashboard__content">
                    <div class="form__wrapper">
                      <div class="form__body">
                        <h3>Edit Service</h3>
                        <form action="./jsp/edit_serviceJSP.jsp" method="POST">
                            <input type="text" hidden name="service-id" id="service-id" value='<%= serviceID %>'>
                            <label for="">
                                <span>Name *</span>
                                <input
                                  type="text"
                                  name="service-name"
                                  id="service-name"
                                  value='<%= resultSet.getString("service") %>'
                                  required
                                />
                              </label>
                              <label for="">
