...
<html lang="en">
  ...
  <body>
    <%
        int mechanicID = Integer.parseInt(request.getParameter("mechanic-id"));
        ...
        try {
          ...
          String queryString = "UPDATE Mechanic SET fname=?, lname=?, email=?, address=?, contact=?, dob=?, sex=?, garage_id=? WHERE mechanic_id = '" + mechanicID + "'";
                 ...
                 <div class="flow-container center">
                  <div class="notification__wrapper">
                      <div class="notification__info">
                          <span>Successfully Updated Mechanic</span>
                      </div>
                      <a href='../mechanic.jsp?ID=<%= mechanicID %>' class="notification__button">
                          Go Back
                      </a>
                  </div>
                 </div>
