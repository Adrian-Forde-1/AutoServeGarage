  ...
  <body>
    <%
        ...
        try {
          ...
          String queryString = "UPDATE User SET fname=?, lname=?, email=?, address=?, contact=?, dob=?, sex=? WHERE user_id = '" + customerID + "'";
                   ...
                   <div class="flow-container center">
                    <div class="notification__wrapper">
                        <div class="notification__info">
                            <span>Successfully Updated Customer</span>
                        </div>
                        <a href='../customer.jsp?ID=<%= customerID %>' class="notification__button">
                            Go Back
                        </a>
                    </div>
                   </div>
