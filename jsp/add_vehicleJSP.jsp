  ...
  <body>
    <%
        ...
        try {
          ...
          String queryString = "INSERT INTO Vehicle (user_id, vehicle_name, manufacturer, manufactured_date, milage, color) VALUES (?, ?, ?, ?, ?, ?)";

            pstatement = connection.prepareStatement(queryString);
            pstatement.setInt(1, customerID);
            pstatement.setString(2, vehicleName);
            pstatement.setString(3, vehicleManufacturer);
            pstatement.setString(4, vehicleManufacturedDate);
            pstatement.setInt(5, vehicleMilage);
            pstatement.setString(6, vehicleColor);
                     ...
                     <div class="flow-container center">
                      <div class="notification__wrapper">
                          <div class="notification__info">
                              <span>Successfully Added Vehicle</span>
                          </div>
                          <a href='../add_vehicle.jsp?ID=<%= customerID %>' class="notification__button">
                              Go Back
                          </a>
                      </div>
                     </div>
