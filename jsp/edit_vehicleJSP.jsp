  ...
  <body>
    <%
        ...
        try {
          ...
          String queryString = "UPDATE Vehicle SET vehicle_name=?, manufacturer=?, manufactured_date=?, color=?, milage=? WHERE vehicle_id = '" + vehicleID + "'";

          pstatement = connection.prepareStatement(queryString);
          pstatement.setString(1, vehicleName);
          pstatement.setString(2, vehicleManufacturer);
          pstatement.setString(3, vehicleManufacturedDate);
          pstatement.setString(4, vehicleColor);
          pstatement.setInt(5, vehicleMilage);
                   ...
                   <div class="flow-container center">
                    <div class="notification__wrapper">
                        <div class="notification__info">
                            <span>Successfully Updated Vehicle</span>
                        </div>
                        <a href='../view_vehicles.jsp?ID=<%= vehicleID %>' class="notification__button">
                            Go Back
                        </a>
                    </div>
                   </div>
