...
<html lang="en">
  ...
  <body>
    <%
        String sID = request.getParameter("stock-id");
        String stockName = request.getParameter("stock-name");
        String stockManufacturer = request.getParameter("stock-manufacturer");
        String stockCost = request.getParameter("stock-cost");
        String stockAmount = request.getParameter("stock-amount");
        String stockGID = request.getParameter("stock-garage-id");
        int stockGarageID = Integer.parseInt(stockGID);
        ...
        try {
          ...
          String queryString = "UPDATE Item SET name=?, cost=?, stock=?, manufacturer=?, garage_id=? WHERE item_id = '" + stockID + "'";

          pstatement = connection.prepareStatement(queryString);
          pstatement.setString(1, stockName);
          pstatement.setString(2, stockCost);
          pstatement.setString(3, stockAmount);
          pstatement.setString(4, stockManufacturer);
          pstatement.setInt(5, stockGarageID);
                       ...
                       <div class="flow-container center">
                        <div class="notification__wrapper">
                            <div class="notification__info">
                                <span>Successfully Updated Stock</span>
                            </div>
