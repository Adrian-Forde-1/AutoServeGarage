  ...
  <body>
    <%
        ...
        try {
          ...
          String queryString = "INSERT INTO USER (fname, lname, email, address, contact, dob, sex, role) VALUES(?, ?, ?, ?, ?, ?, ?, 2)";
          ...
          if(updateQuery != 0) { 
            ...
            if(customerResultSet.next()) {
              int customerID = customerResultSet.getInt("user_id");
              PreparedStatement vehiclePStatement = null;
              int vehicleUpdateQuery = 0;
              String vehicleInsertQuery = "INSERT INTO Vehicle (user_id, vehicle_name, manufacturer, manufactured_date, milage, color) VALUES (?, ?, ?, ?, ?, ?)";

              vehiclePStatement = connection.prepareStatement(vehicleInsertQuery);
              ...
              vehicleUpdateQuery = vehiclePStatement.executeUpdate();
